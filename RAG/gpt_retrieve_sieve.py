...
#make keywords from statements then do keyword search 
search_and_retrieve_keyword('Agentic_sieved_RAG', 'new_ref_found_Agentic')

#Process (no embedding)
process_pdfs_to_mongodb_noembed(files_directory='papers', collection1='new_chunked_noembed')

#retrieve and sieve using gpt 4o
retrieve_sieve_references(collection_processed_name='new_chunked_noembed',valid_collection_name='Agentic_sieved_RAG_new', invalid_collection_name='No_match_agentic_new')