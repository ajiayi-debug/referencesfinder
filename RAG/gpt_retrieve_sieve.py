...
#retrieve and sieve using gpt 4o
retrieve_sieve_references_new(collection_processed_name='new_chunked_noembed',new_ref_collection='new_ref_found_Agentic',valid_collection_name='Agentic_sieved_RAG_new', invalid_collection_name='No_match_agentic_new',not_match='no_match')